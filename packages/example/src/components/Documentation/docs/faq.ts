...
## 1. What is Zion?
Zion is an innovative application that lets you manage your ReddCoin directly within MetaMask, without the need for token wrapping.
...
Zion needs extended public keys to derive addresses, there extended public keys are needed since Zion supports three different address type in ReddCoin. 

## 7. Does Zion access my private keys?
No, Zion only needs extended public keys to derive addresses, private keys are managed by reddsnap and will never leave MetaMask.
...
To receive testnet ReddCoin, switch to "Testnet" and request test coins from [Coinfaucet](https://coinfaucet.eu/en/btc-testnet/) or [Bitcoinfaucet](https://bitcoinfaucet.uo1.net/). This lets you start experimenting.

## 9. How do I send ReddCoin to someone?
To send ReddCoin:
...
- MetaMask will ask you to "Approve" the transaction. Once approved, your RDD will be sent, and the transaction will be successfully broadcast.

## 10. How can I receive payments?
To receive ReddCoin: Click "Receive" and use the address displayed to receive your RDD.

## 11. How do I change address types?
To switch address types:
- Click "ReddCoin" in the top-right corner.
...
- Click "ReddCoin" in the top-right corner.
- Open the wallet profile through the settings button.
- Enable "Dynamic Address" to generate a new ReddCoin address each time you receive a deposit, enhancing your privacy.
